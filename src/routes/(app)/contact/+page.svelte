...
<div class="grid grid-cols-1 gap-3 grid-flow-row w-dvw py-14 px-[15%]">
    ...
    <Card title="Chatroom" inner_padding="px-[15%] py-8" author="" date="" doc_type="document" height="h-fill" background="bg-black/25" color="text-white" width="w-full" inner_width="w-full" enable_image={false}>
