...
<div class="grid grid-cols-1 gap-3 grid-flow-row w-dvw py-14 px-[15%]">
    ...
    <Card title="Where to find me?" inner_padding="px-[15%] py-8" author="" date="" doc_type="document" height="h-fill" background="bg-black/25" color="text-white" width="w-full" enable_image={false}>
        <ul>
            <li>
                <a href="https://github.com/Qinbeans" target="_blank" class="flex gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 30 30" class="w-8 h-8">
            ...
            <li>
                <a href="https://www.linkedin.com/in/rybeats/" target="_blank" class="flex gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50" class="w-8 h-8">
