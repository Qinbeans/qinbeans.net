<div class="grid place-content-center w-screen h-screen">
    <div class="grid place-content-center grid-cols-1 bg-slate-500 bg-opacity-60 dark:bg-black dark:bg-opacity-75 rounded-lg w-fit h-fit p-1.5 text-3xl sm:text-xl">
        ...
        <textarea class="pl-1.5 pr-1.5 rounded-lg bg-gray-700" name="content" id="content" cols="20" rows="2"></textarea>
        ...
        <button class="shadow cursor-pointer pl-1.5 pr-1.5 rounded-lg bg-gray-400 dark:bg-zinc-600 text-pink-500 hover:border-2 border-solid border-pink-500">Submit</button>
    </div>
</div>